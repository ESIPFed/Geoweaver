...
GW.fileupload = {
      ...
      if (GW.host.findCache(hid) == null) {
        if (GW.fileupload.password_frame != null) {
          try {
            ...
            console.error(
              "Fail to close the frame. Probably it is already closed.",
            );
          }
        ...
        GW.fileupload.password_frame = GW.process.createJSFrameDialog(
          350,
          250,
          content,
          "Authorization",
        ...
        GW.fileupload.password_frame.on(
          "closeButton",
          "click",
          (_frame, evt) => {
            _frame.closeFrame();
  ...
  getUploadDialogContent: function (hasdebug) {
    var content =
      '<div class="modal-body" style="font-size: 12px;"><div class="row"  style="padding:10px;">' +
  ...
  showUploadWorkflowDialog: function () {
    ...
    this.uploader = GW.process.createJSFrameDialog(
      550,
      450,
      content,
      "Upload Workflow",
  ...
  listenUploadButtons: function (iftransfer, ifworkflow) {
    $("#drag-and-drop-zone").dmUploader({
      ...
      onBeforeUpload: function (id) {
        ...
        GW.fileupload.ui_multi_update_file_status(
          id,
          "uploading",
          "Uploading...",
        );
      ...
      onUploadSuccess: function (id, data) {
        ...
        GW.fileupload.ui_add_log(
          "Server Response for file #" + id + ": " + data,
        );
        GW.fileupload.ui_add_log(
