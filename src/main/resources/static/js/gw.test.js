  ...
  run: function () {
    ...
    describe("Geoweaver", function () {
      describe(".general()", function () {
        it("process", function () {
          GW.process.addMenuItem(
            { id: "xyzxyz", name: "testProcess" },
            "process",
          );
        ...
        it("workflow", function () {
          ...
          GW.workflow.display({
            ...
            confidential: "FALSE",
            edges:
              '[{"source":{"title":"testpython2","id":"nq1huz-iWizg","x":580.8966674804688,"y":187.61172485351562},"target":{"title":"sdggkkk","id":"j0uraj-lNCK0","x":897,"y":8}}]',
            nodes:
              '[{"title":"testpython2","id":"nq1huz-iWizg","x":580.8966674804688,"y":187.61172485351562},{"title":"sdggkkk","id":"j0uraj-lNCK0","x":897,"y":8}]',
          });
