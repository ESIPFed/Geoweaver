        ...
        describe('Geoweaver', function(){
            describe('.addMenuItem()', function(){
                ...
                it('host', function(){
                    ...
                    GW.host.list([{"id":"oy1pa5","name":"localhost","ip":"127.0.0.1","port":"22","username":"test","owner":"111111","type":"ssh","url":"","confidential":"FALSE"},{"id":"h8avme","name":"New Host","ip":"","port":"","username":null,"owner":"111111","type":"jupyterhub","url":"sdfds","confidential":"FALSE"},{"id":"hocqgp","name":"Geobrain","ip":"129.174.131.229","port":"22","username":"zsun","owner":"111111","type":"ssh","url":"","confidential":"FALSE"}]);
                    GW.host.validateIP();
