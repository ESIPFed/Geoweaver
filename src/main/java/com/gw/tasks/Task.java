 ...
 *
 * @author ziheng
 * @time Aug 10, 2015 4:04:57 PM Original aim is to support Geoweaver.
 */
public abstract class Task {
  ...
  /** Call back function Return the execution results */
  public abstract void responseCallback();

  /** Call back function If the execution fails */
