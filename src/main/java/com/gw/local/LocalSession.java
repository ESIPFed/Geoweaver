...
public interface LocalSession {
  ...
  /**
   * Check if this session is closed. Notice: only work for process that has waitFor enabled. the
   * process without join doesn't work.
   *
   ...
   * @param script
   * @param processid
   * @param isjoin is terminal or not
