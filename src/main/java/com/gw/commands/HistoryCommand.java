...
/**
 * This class represents a command-line command for displaying the history of a process or workflow
 * run. It uses the picocli library to define the command and its parameters. When executed, it
 * retrieves the history details and displays them in a table format.
 */
@Component
...
public class HistoryCommand implements Runnable {
  ...
  /**
   * The run method is called when this command is executed. It retrieves the history details for
   * the specified history_id and displays them in a table.
   */
  @Override
  public void run() {
