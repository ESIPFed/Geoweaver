...
/**
 * This class represents a command-line command for listing resources in Geoweaver. Users can list
 * hosts, processes, or workflows using different command options. The `picocli` library is used for
 * defining the command and its parameters.
 */
...
public class ListCommand implements Runnable {
  ...
  /**
   * The run method is called when this command is executed. Depending on the specified resource
   * type (host, process, or workflow), it retrieves and displays the corresponding resources in a
   * table format.
   */
  public void run() {
