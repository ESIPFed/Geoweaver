...
class requiredDetailCommandOptions {
  ...
  @Option(
      names = {"--host-id"},
      description = "Host Id to get details for")
  String hostId;

  @Option(
      names = {"--process-id"},
      description = "Process Id to get details for")
  String processId;

  @Option(
      names = {"--workflow-id"},
      description = "Workflow Id to get details for")
  String workflowId;
  ...
  public void run() {
    ...
    if (requiredCommandOptions.hostId != null) {
      ...
      if (workflow.isPresent()) {
        ...
        // Set Headers for table
        table.setHeaders(
            new String[] {"Workflow Id", "Name", "Description", "Owner", "Confidential?"});
        ...
        // Add error row
        table.addRow(
            "Workflow Id", "No workflow found with id: " + requiredCommandOptions.workflowId);
      }
