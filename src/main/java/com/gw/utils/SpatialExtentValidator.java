...
public class SpatialExtentValidator {
  ...
  public static boolean validate(
      String north, String south, String west, String east, String proj, String productcategory) {
    boolean valid = false;
    try {
      ...
      throw new RuntimeException(
          "The input spatial coordinates or projection are incorrect." + e.getLocalizedMessage());
    }
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        SpatialExtentValidator.validate(
            "38.479394673276445",
            "37.37015718405753",
            "-78.84201049804688",
            "-77.78732299804688",
            "ESPG:4326",
            "16 days 250m global customizable VCI"));
    ;
  }
}
