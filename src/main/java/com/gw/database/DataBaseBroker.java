...
////		SELECT  `identifier`,  `abbreviation`,  LEFT(`desc`, 256),  LEFT(`keywords`, 256),  `name`,  `east`,  `south`,  `west`,  `north`,  `srs`,  `begintime`,  `endtime`,  `ifvirtual`,  `parent_abstract_model`,  `dataFormat`,  LEFT(`accessURL`, 256),  LEFT(`ontology_reference`, 256),  `lastUpdateDate` FROM `Geoweaver`.`products` LIMIT 1000;
//		StringBuffer sql = new StringBuffer("select identifier, name from Geoweaver.products;");
...
//		StringBuffer sql = new StringBuffer("insert into Geoweaver.orders (orderid, product, ordertime, updatetime,  email, status, message, parametermap, begintime, userid) values ('");
...
//		StringBuffer sql = new StringBuffer("insert into Geoweaver.orders (orderid, product, ordertime, updatetime, project,  east, south, west, north, email, begintime, endtime, status, message) values ('");
//		BaseTool tool = new BaseTool();
...
//		BaseTool tool = new BaseTool();
//		String curtime = tool.getCurrentMySQLDatetime();
//		StringBuffer sql = new StringBuffer("update Geoweaver.orders set status = '").append(status).append("', updatetime = '").append(curtime).append("', endtime = '").append(curtime).append("' where orderid = '").append(oid).append("';");
...
//		String curtime = tool.getCurrentMySQLDatetime();
//		StringBuffer sql = new StringBuffer("update Geoweaver.orders set status = '").append(status).append("', updatetime = '").append(curtime).append("', endtime = '").append(curtime).append("', message = '").append(message).append(" ' where orderid = '").append(oid).append("';");
//		logger.info(sql.toString());
//		DataBaseOperation.update(sql.toString());
//	}
//	/**
...
//		StringBuffer sql = new StringBuffer("select status from Geoweaver.orders where orderid = '").append(orderid).append("';");
//		ResultSet rs = DataBaseOperation.query(sql.toString());
//		String status = null;
//		try {
//			if(rs.next()){
...
//   	 sql.append("select identifier, name from Geoweaver.products;");
//   	 ResultSet rs = DataBaseOperation.query(sql.toString());
//   	 List productlist = new ArrayList();
//   	 try{
//   		 while(rs.next()){
...
//		StringBuffer sql = new StringBuffer("update Geoweaver.orders set message = '").append(message).append("' where orderid = '").append(orderid).append("';");
//		DataBaseOperation.update(sql.toString());
//	}
//	/**
...
//		StringBuffer sql = new StringBuffer("insert into Geoweaver.products (identifier, abbreviation, description, keywords, name, east, south, west, north, srs, begintime, endtime, ifvirtual, parent_abstract_model, dataFormat, accessURL, ontology_reference, lastUpdateDate ) values ('").append(id).append("', '").append(abbr).append("','");
...
//		StringBuffer sql = new StringBuffer("select abstract_model.identifier from Geoweaver.abstract_model, Geoweaver.products where products.name = '").append(product).append("' and products.parent_abstract_model = abstract_model.identifier;");
//		logger.info(sql.toString());
//		ResultSet rs = DataBaseOperation.query(sql.toString());
//		String amid = null;
//		try {
...
//		StringBuffer sql = new StringBuffer("select name from Geoweaver.products where identifier = '").append(productid).append("';");
//		logger.info(sql.toString());
//		ResultSet rs = DataBaseOperation.query(sql.toString());
//		String name = null;
//		try {
...
//		StringBuffer sql = new StringBuffer("select parametermap from Geoweaver.orders where orderid = '").append(oid).append("';");
//		logger.info(sql.toString());
//		ResultSet rs = DataBaseOperation.query(sql.toString());
//		String pmap = null;
//		try {
