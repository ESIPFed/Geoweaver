  ...
  public void downloadFile(
    ...
    try {
      ...
      if (file.exists()) {
         ...
         * indicating if the content is expected to be displayed inline in the browser, that is, as
         * a Web page or as part of a Web page, or as an attachment, that is downloaded and saved
         * locally.
         */
