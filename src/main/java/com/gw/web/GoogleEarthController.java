...
public class GoogleEarthController {
  ...
  String addURLProxy(String resp, String hostID) {
    if (!BaseTool.isNull(resp))
      resp =
          resp.replace(
                  "\"/images/GoogleEarthEngine_v1.png",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/images/GoogleEarthEngine_v1.png")
              .replace(
                  "\"/javascript/polyfills/webcomponentsjs/webcomponents-loader.js",
                  "\"/Geoweaver/GoogleEarth-proxy/"
                      + hostID
                      + "/javascript/polyfills/webcomponentsjs/webcomponents-loader.js")
              .replace(
                  "\"/javascript/polyfills/web-animations-next-lite.min.js",
                  "\"/Geoweaver/GoogleEarth-proxy/"
                      + hostID
                      + "/javascript/polyfills/web-animations-next-lite.min.js")
              .replace(
                  "\"/javascript/playground.js",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/javascript/playground.js")
              .replace(
                  "\"/css/playground.css",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/css/playground.css")
              .replace(
                  "\"/javascript/autotrack.js",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/javascript/autotrack.js")
              .replace(
                  "\"/javascript/escodegen.js",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/javascript/escodegen.js")
              .replace("\"/ace/ace.js", "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/ace/ace.js")
              .replace(
                  "\"/javascript/acorn.js",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/javascript/acorn.js")
              .replace(
                  "\"/javascript/stan.js",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/javascript/stan.js")
              .replace(
                  "\"/images/vertical_handle.png",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/images/vertical_handle.png")
              .replace(
                  "\"/images/bigicon.png",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/images/bigicon.png")
              .replace(
                  "\"/images/info.png",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/images/info.png")
              .replace(
                  "\"/images/loading.gif",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/images/loading.gif")
              .replace(
                  "\"/favicon.png", "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/favicon.png")
              .replace(
                  "\"/preferences/set",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/preferences/set")
              .replace(
                  "\"/namespace/user",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/namespace/user")
              .replace(
                  "\"/cloud/projects",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/cloud/projects")
              .replace(
                  "\"/versions/script_manager",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/versions/script_manager")
              .replace(
                  "\"/repo/list?only_default=true",
                  "\"/Geoweaver/GoogleEarth-proxy/" + hostID + "/repo/list")
  ...
  private String getRealRequestURL(String requesturi) {
    ...
    String realurl =
        requesturi.substring(
            requesturi.indexOf("GoogleEarth-proxy")
                + 24); // http://localhost:8070/Geoweaver/GoogleEarth-proxy/ikpyln/
   ...
   * @param oldheaders
   * @param h
   * @param realurl the suffix after the host ip and port
   * @param querystr the query string after question mark ?
   * @return
   */
  private HttpHeaders updateRequestHeader(
    ...
    try {
      ...
      // URI uri = new URI("https", null, "code.earthengine.google.com", 443, realurl, querystr,
      // null);
      ...
      // newheaders.set("Cookie", "1P_JAR=2021-08-05-12;
          ...
          try {
            ...
            if (lowkey.equals("location")) {
              ...
              for (String singleval : value) {
                ...
                String newsingleval =
                    singleval.replace("Path=", "Path=" + "/Geoweaver/GoogleEarth-proxy/" + hostid);
...
//   * @param headers
   ...
   */
  private ResponseEntity processGET(
    ...
    try {
      ...
      // restTemplate.exchange("https://code.earthengine.google.com/", method, newentity,
      // byte[].class);

      // URI uri = new URI("https", null, "https://code.earthengine.google.com/", 443,
      ...
      HttpHeaders respheaders =
          updateResponseHeader(responseEntity.getHeaders(), responseEntity.getBody(), hostid);

      resp =
          new ResponseEntity<byte[]>(
              responseEntity.getBody(), respheaders, responseEntity.getStatusCode());
      ...
      // if(!BaseTool.isNull(responseEntity.getBody()) && !targeturl.contains(".png") &&
      // !targeturl.contains(".woff")
      //  && !(!BaseTool.isNull(contenttype) && (contenttype.contains("image") ||
  ...
  @RequestMapping(
      value = "/GoogleEarth-proxy/{hostid}/**",
