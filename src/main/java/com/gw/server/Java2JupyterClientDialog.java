...
public class Java2JupyterClientDialog extends JFrame {
  ...
  Map<String, List<String>> getHeaders() {
    ...
    //     GET
    // ws://localhost:8080/Geoweaver/jupyter-socket/api/kernels/50b8eae7-e877-45a5-9686-fb99f179bec4/channels?session_id=7587997d388b4669965953d6506c9c33 HTTP/1.1
    //	  Host: localhost:8080
    //	  Connection: Upgrade
    //	  Pragma: no-cache
    ...
    //	  Cookie: JSESSIONID=6A76ED20085E0D3F2C56248F370D765C;
    // username-localhost-8888="2|1:0|10:1589056727|23:username-localhost-8888|44:OTc5NGFkYjk5Mjc0NGZhODk4YjdlZTljMTdlYjhkYzg=|2b129b076ea248da7bb60b67ef5215ace4e1f22d5b8357892740daf831011afb"; _xsrf=2|71c72b4a|edbb6345b2cfe9820c5f7ae7bbb029af|1589331447
  ...
  public Java2JupyterClientDialog() throws Exception {
    ...
    String wsurl =
        "ws://localhost:8080/Geoweaver/jupyter-socket/api/kernels/8b7e9d57-c83b-4449-91d8-c0486c99c389/channels?session_id=e792c1994197490d8c8780dac70d3d07";
    ...
    //      client = new Java2JupyterClientEndpoint(new
    // URI("ws://localhost:8888/api/kernels/884447f1-bac6-4913-be86-99da11b2a78a/channels?session_id=42b8261488884e869213604975141d8c"), null, getHeaders());
