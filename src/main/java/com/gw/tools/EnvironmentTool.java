...
public class EnvironmentTool {
  ...
  @Autowired EnvironmentRepository envrep;
  ...
  public void addNewEnvironment(
      String pypath, List<Environment> old_envlist, String hostid, String name) {
    ...
    if (BaseTool.isNull(theenv)) {
      ...
      if (pypath.contains("conda")) env.setPyenv("anaconda");
      else env.setPyenv("pip");
  ...
  public String getEnvironmentByBEB(String hostid, String bin, String env, String basedir) {
    ...
    try {
      ...
      Collection<Environment> envlist =
          environmentrepository.findEnvByID_BIN_ENV_BaseDir(hostid, bin, env, basedir);
